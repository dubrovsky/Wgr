 ...
 */
public class PoezdZayavDAOHib  extends GenericHibernateDAO<PoezdZayav, Long> implements PoezdZayavDAO {

    @Override
    public List<PoezdZayav> findAll(Integer limit, Integer start, long routeId, Byte direction, List<Filter> filters, Usr usr, Locale locale) {
...
//        crit.add(Restrictions.eq("transport", "P"));
    ...
    @Override
    public List<PoezdZayav> findByIds(List<Long> ids) {
        Criteria crit = getSession().createCriteria(getPersistentClass());
