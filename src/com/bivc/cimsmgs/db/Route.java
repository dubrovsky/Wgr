 ...
 */
@JsonIgnoreProperties({"dattr", "cimSmgsScans", "cimSmgses", "routeGroupses", "routeDocs", "invoices", "packDocs", "invoicesBrief", "cimSmgsFileInfs", "routePrintTemplateses", "routeUnPrintTemplateses", "doc2docTemplsRouteUnRefses", "doc2docTemplsRouteRefses", "poezds",
		"avtos", "sectors"})
public class Route implements Serializable, Comparable<Route> {
    ...
    private Set<YardSector> sectors = new HashSet<>();

    public Set<YardSector> getSectors() {
        return sectors;
    }

    public void setSectors(Set<YardSector> sectors) {
        this.sectors = sectors;
    }
    /*private Boolean forDeleted = false;
...
//        printTemplate.setUsrGroupsDir(this.get);
   ...
   /* public List<DocDir> docsWithoutPrintTemplate(){
    ...
    public boolean equals(Object o) {
        ...
        Route route = (Route) o;
        return Objects.equals(hid, route.hid) &&
                Objects.equals(project != null ? project.getHid() : "", route.project != null ? route.project.getHid() : "") &&
                Objects.equals(name, route.name) &&
                Objects.equals(tbc_st_code, route.tbc_st_code) &&
                Objects.equals(customCode, route.customCode) &&
                Objects.equals(emailMask, route.emailMask);
    }

    @Override
    public int hashCode() {
        return Objects.hash(hid, project != null ? project.getHid() : "", name, tbc_st_code, customCode, emailMask);
    }
