...
public class Bankaccount implements java.io.Serializable {
	...
	public Bankaccount(BigDecimal id, Company company, Country country,
			String bankCode, String bankName, String bankNameLatin1,
			String accountNr) {
		this.id = id;
	...
	public Bankaccount(BigDecimal id, Company company, Country country,
			String bankCode, String bankName, String bankNameLatin1,
			String accountNr, String corBankName, String corBankCode,
			String bankCodeOkpo, String bankCodeInn, String bankCodeBik) {
		this.id = id;
		this.company = company;
		this.country = country;
		this.bankCode = bankCode;
