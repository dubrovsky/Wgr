 ...
 */
@JsonIgnoreProperties({"groups","usrs","packDocs","routeGroupses","projectGroupses","locked","un","dattr","printTemplateses","fieldsAccessFobiddens","docsFobiddenUsrGroupses","yardSectorGroups", "clientGroups"})
public class UsrGroupsDir implements Serializable {
	...
	private Set<YardSectorGroups> yardSectorGroups = new HashSet<>();
	private Set<ClientGroups> clientGroups = new HashSet<>();
