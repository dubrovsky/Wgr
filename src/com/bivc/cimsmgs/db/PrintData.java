 ...
 */
@JsonIgnoreProperties({"printTemplates","printDataTables","printDataPhrases"})
...
public class PrintData implements Serializable {
    ...
    private Map<Integer,PrintDataTable> printDataTables = new TreeMap<>();
    private Map<Integer,PrintDataPhrase> printDataPhrases = new TreeMap<>();
    private Integer rotate;
    private Boolean border = false;
    private Boolean underline = false;


    public Map<Integer,PrintDataPhrase> getPrintDataPhrases() {
        return printDataPhrases;
    }

    public void setPrintDataPhrases(Map<Integer,PrintDataPhrase> printDataPhrases) {
        this.printDataPhrases = printDataPhrases;
    }
    ...
    public PrintData(PrintTemplates prnTempl, String name, float llx, float lly, float urx, float ury) {
        this.printTemplates = prnTempl;
        this.name = name;
        this.llx = llx;
        this.lly = lly;
        this.urx = urx;
   ...
   /* public Integer getTableColumns() {
        return printDataTables.values().size() == 0 ? null : printDataTables.values().size();
    }*/

    public Map<Integer,PrintDataTable> getPrintDataTables() {
        return printDataTables;
    }

    public void setPrintDataTables(Map<Integer,PrintDataTable> printDataTables) {
        this.printDataTables = printDataTables;
    }

    public List<PrintDataTable> getPrintDataTable() {
        ArrayList<PrintDataTable> result = new ArrayList<>();
        for (PrintDataTable printData : printDataTables.values()) {
            result.add(printData);
        }
        return result;
    }

    public List<PrintDataPhrase> getPrintDataPhrase() {
        ArrayList<PrintDataPhrase> result = new ArrayList<>();
        for (PrintDataPhrase printData : printDataPhrases.values()) {
            result.add(printData);
        }
        return result;
    }
