SELECT k.HID,
       ...
       a1.NO_AVTO AS NVAG1, '' AS NPPR1, a1.DPRB,
       ...
       a2.DOTP, 'AUTO' AS KOLEYA, a2.NO_AVTO AS NVAG2, a2.DRIVER_NM
...
FROM KY_KONT k
         ...
         JOIN KY_AVTO a1
              ON a1.HID=h1.HID_AVTO AND a1.DIRECTION=1
         JOIN KY_AVTO a2
              ON a2.HID=h2.HID_AVTO AND a2.DIRECTION=2

WHERE a1.DPRB>=? AND a1.DPRB<?
ORDER BY DPRB