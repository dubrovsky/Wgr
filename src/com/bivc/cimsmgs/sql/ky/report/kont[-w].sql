SELECT k.HID,
       ...
       k.DOTP,CASE WHEN p1.KOLEYA=2 THEN 'NORMALNY' WHEN p1.KOLEYA=1 THEN 'SZEROKI' END AS KOLEYA, v2.NVAG AS NVAG2, '' AS DRIVER_FIO, '' AS DRIVER_FIO2
...
FROM KY_KONT k
         ...
         JOIN KY_POEZD p1
              ON p1.HID=h2.HID_POEZD AND p1.DIRECTION=2

         LEFT JOIN NSI_CLIENT cl ON k.HID_CLIENT = cl.HID

WHERE h1.HID_VAGON IS NULL AND h1.HID_AVTO IS NULL AND 