Ext.define('TK.view.avisogu29k.List', {
    extend:'TK.view.DocsList',
    alias:'widget.avisogu29klist',
    ...
    buildTopToolbar: function(config) {
        config.dockedItems = new Array({
            ...
            items: [
                ...
                {text: this.btnMakeGU,iconCls:'smgs1', itemId:'aviso2smgs',action:'aviso2smgs', disabled:true},'-',
                {text: this.btnDownload,iconCls:'upload',action:'uploadGU'},'-',
