Ext.define('TK.view.avisogu29k.Form', {
    ...
    buildItems:function (config) {
        config.items = [
            ...
            {xtype:'hidden', name:'smgs.docType1', itemId:'smgs.docType1', value:20},
            {xtype:'hidden', name:'smgs.status', itemId:'smgs.status'},
            {xtype:'hidden', name:'search.docType', itemId:'search.docType', value:'avisogu29k'},
                ...
                items:[
                    {xtype:'fieldcontainer', layout:'hbox', defaults:{margin:'0 5 0 5'},
                        items:[
                            ...
                            {xtype:'textfield', fieldLabel:'№', labelWidth:20, name:'smgs.aviso_num', itemId:'smgs.aviso_num', maxLength:20, width:100},
                            {xtype:'datefield', fieldLabel:this.labelDate, labelWidth:40, name:'smgs.aviso_dat', itemId:'smgs.aviso_dat', width:150},
                            {xtype:'numberfield', fieldLabel:this.labelVsegoGU, labelWidth:70, name:'smgs.amount', itemId:'smgs.amount', minValue:1, value:1, width:150},
                            {xtype:'textfield', fieldLabel:this.labelZakazNum, name:'smgs.zakazNo', itemId:'smgs.zakazNo', maxLength:20, width:200}
                        ]
                    },
                    ...
                    {xtype:'fieldcontainer', itemId:'panel_gu29_g1', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'textarea', fieldLabel:this.labelSender1, width:590, height:120, readOnly:true, name:'disp.g1', itemId:'disp.g1', submitValue:false},
                    ...
                    {xtype:'fieldcontainer', itemId:'panel_gu29_g5', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'textarea', fieldLabel:this.labelReceiver1, width:590, height:120, readOnly:true, name:'disp.g5', itemId:'disp.g5', submitValue:false},
                    ...
                    {xtype:'fieldcontainer', itemId:'panel_gu29_sto', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'textfield', fieldLabel:this.labelStnSender, labelWidth:130, name:'smgs.g692', itemId:'smgs.g692', maxLength:6, width:195},
                            {xtype:'textfield', name:'smgs.g162r', itemId:'smgs.g162r', maxLength:80, width:335},
                            {xtype:'textfield', name:'smgs.g_16_33r', itemId:'smgs.g_16_33r', maxLength:3, width:40},
                    ...
                    {xtype:'fieldcontainer', itemId:'panel_gu29_stn', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'textfield', fieldLabel:this.labelStnReceiver, labelWidth:130, name:'smgs.g121', itemId:'smgs.g121', maxLength:6, width:195},
                            {xtype:'textfield', name:'smgs.g101r', itemId:'smgs.g101r', maxLength:80, width:335},
                            {xtype:'textfield', name:'smgs.g_10_3r', itemId:'smgs.g_10_3r', maxLength:3, width:40},
                    ...
                    {xtype:'fieldcontainer', itemId:'panel_gu29_g4', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'textarea', fieldLabel:this.labelPayers1, width:590, height:70, readOnly:true, name:'disp.g4', itemId:'disp.g4', submitValue:false},
                    ...
                    {xtype:'fieldcontainer', layout:'hbox', defaults:{margin:'0 5 0 0'},
                        items:[
                            {xtype:'datefield', fieldLabel:this.labelCodesTill, labelWidth:200, name:'smgs.aviso_cod_dat', itemId:'smgs.aviso_cod_dat'}
                        ]
                    }
                ]
            },
...
//                            item.setActiveTab(0);
    ...
    initServiceFields:function (data, initGrids) {
        ...
        if (initGrids) {
            this.getComponent('g9_panel').initServiceFields(data);
        }
    ...
    prepareGridData4Save:function () {
        return this.getComponent('g9_panel').prepareData();
    },
    /*onGetClass4CommentsGridBtns: function (value, meta, record) {
...
//                btn.hide();
//                btn.ownerCt.getComponent('add_').hide();
        }
    },
    doStatus:function () {
        var toolbar = this.dockedItems.items[1],
            toolbar1 = this.dockedItems.items[0],
            form = this.getForm(), status = form.findField('smgs.status').getValue();
