Ext.define('TK.view.aviso.Form', {
    ...
    buildItems:function (config) {
        config.items = [
            ...
            {xtype:'hidden', name:'smgs.docType1', itemId:'smgs.docType1', value:3},
            {xtype:'hidden', name:'search.docType', itemId:'search.docType', value:'aviso'},
...
//                scope:this,
            ...
            /*{xtype:'box',x:683, y:564, width:495, height:137, itemId:'disp.g27v',
...
//                scope:this,
            ...
            /*{xtype:'box',x:203, y:795, width:800, height:280, itemId:'disp.g27g',autoEl:{tag: 'table'}},
             {
             xtype:'button',
             text:'Изменить груз',
             x:607, y:770,
