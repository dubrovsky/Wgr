Ext.define('TK.view.aviso2.List', {
    ...
    buildColumns: function(config) {
    	config.columns = {
            items:[
                ...
                {text: 'Статус', dataIndex: 'status', renderer: this.renderStatus},
                {text: '№ инструкции', dataIndex: 'avizo_num', renderer: this.rendererGraph},
                {text: this.headerContNum, dataIndex: 'konts'},
                {text: 'ГНГ', dataIndex: 'gng'},
