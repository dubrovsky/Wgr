    ...
    buildColumns:function (config) {
        config.columns = {
            items:[
                ...
                {text:this.headerGu27v, dataIndex:'numClaim', flex:1, renderer: this.rendererPrint},
                {text:this.headerAvisoNum, dataIndex:'aviso', flex:1                                     },
                {text:this.headerVagNum, dataIndex:'vags', flex:1, renderer:TK.Utils.renderLongStr},
                {text:this.headerContNum, dataIndex:'konts', width:100, renderer:TK.Utils.renderLongStr},
//                {text:this.headerDateTransp, dataIndex:'g281', flex:1                                     },
                {text:this.headerSenderName, dataIndex:'g1', flex:3, renderer:TK.Utils.renderLongStr},
                {text:this.headerReceiverName, dataIndex:'g4', flex:3, renderer:TK.Utils.renderLongStr}
            ],
            defaults:{}
        };
    },
