...
/////////////////////////////////
Ext.define("TK.locale.zh_CN.view.kontyard.List", {
    override:"TK.view.kontyard.List",

    headerCreation    :'创建',
    headerDateTime    :'日期和时间',
    headerUser        :'使用人',

    headerNKont        :'Container number',
    headerDateIn        :'Placement',
    headerDateOut        :'Movement',
    headerSector        :'YardSector',
    headerLoaded        :'Loaded',
    ...
    title:'List of containers on yard'

});

Ext.define("TK.locale.zh_CN.view.kontyard.Form", {
    override:"TK.view.kontyard.Form",

    btnSave         :'保存',
    btnCancel     :'Cancel',
    btnClose        :'关闭',

    labelNKont:'Container\'s number',
    labelX     :'X',
    labelY     :'Y',
    labelZ   :'Z',
    labelDateIn  :'Placement',
    labelDate  :'日期',
    labelTime  :'time',
    labelDateOut  :'Movement',

    labelSector  :'YardSector',
    labelLoaded  :'Loaded',
    labelStorageType  :'Storage',
    labelStorageVACANT  :'Vacant',
    labelStorageTEMPORALLY  :'Temporally',
    labelStorageSTORAGE  :'Storage',
    labelMileage  :'Mileage(km)',
    labelNotes  :'Notes',
    msgSearch  :'Searching...',
    msgNothingFound:'No matching records found.'
});

Ext.define("TK.locale.zh_CN.view.kontyard.Filter", {
    override:"TK.view.kontyard.Filter",
    title: 'Filter',
...
Ext.define("TK.locale.zh_CN.controller.Kontyard", {
    override:"TK.controller.Kontyard",
...
Ext.define("TK.locale.zh_CN.VTypes", {
    override       :"TK.VTypes",
...
Ext.define("TK.locale.zh_CN.view.edit.DetailGrid", {
    ...
    headerContNum      :'集装箱号码 (9,19)',
    headerContSize     :'集装箱大少(9)',
    headerContVid      :'集装箱种类(18)',
...
Ext.define("TK.locale.zh_CN.view.nsi.List", {
    ...
    titleDeliv       :'供应条件的手册',
    titleUpak        :'包装种类的手册',
    titleKontSector        :'Handbook of sectors',
