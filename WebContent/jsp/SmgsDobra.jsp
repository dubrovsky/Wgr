...
<link rel="stylesheet" type="text/css" href="../css/SmgsDobra.css">
<title>SMGS</title>
</head>
<body>
<%--<img src="../../doc/smgs/smgs2-dorVed-96dpi.jpg">--%>
<div class="d1">
   	...
   	<div class="d891_2">			
        <table width="100%">
            <s:iterator value="smgs.cimSmgsPlombs.entrySet()">
                <tr>
                    <td width="47"><s:property value="value.kpl"/>&nbsp;</td>
