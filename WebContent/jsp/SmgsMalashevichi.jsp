...
<link rel="stylesheet" type="text/css" href="../css/SmgsMalashevichi.css">
<title>SMGS</title>
</head>
<body>
<img src="../../doc/malashevichi/SMGS-PKP-96dpi.gif">
<div class="d1">
                        ...
                        <tr>
                            ...
                            <td width="68">
                                <s:if test="%{#rowstatus.first}">
                                    <s:property value="smgs.g12SmgsDispMalash()" escapeHtml="false" />
                                </s:if>
                            </td>
                            <td width="88">
                                <s:if test="%{#rowstatus.first}">
   	...
   	<div class="d891_2">			
        <table width="100%">
            <s:iterator value="smgs.cimSmgsPlombs.entrySet()">
                <tr>
                    <td width="59"><s:property value="value.kpl"/>&nbsp;</td>
                    <td width="236"><s:property value="value.znak"/>&nbsp;</td>
                </tr>
            </s:iterator>
        </table>
    </div> 
