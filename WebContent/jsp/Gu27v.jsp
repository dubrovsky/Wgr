<%@page contentType="text/html; charset=utf-8" %><%@taglib prefix="s" uri="/struts-tags" %><%@taglib uri="/WEB-INF/tlds/pd4ml.tld" prefix="pd4ml" %><pd4ml:transform screenWidth="761" pageFormat="571x810" pageOrientation="portrait" pageInsets="0,0,0,0,mm">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/Gu27v.css">
    <title>Gu27v</title>
</head>
<body style="margin: 0">
    <img src="../../doc/ГУ-29К(РЖД)/gu27v-96dpi.jpg">
   <%--<s:if test="print.page1">
       <div style="position:relative; float:left;width:750px;height:1071px;">--%>
            <div class="d0">
...
<div class="d20">
                <table width="100%">
                            ...
                            <s:iterator value="value.cimSmgsGruzs.entrySet()" status="rowstatus">
                                <tr>
                                    ...
                                    <s:if test="value.ekgvn != null && value.ekgvn.length() > 0">
                                            <br/>ЕТСНГ-<s:property value="value.ekgvn" escapeHtml="false"/>
                                    </s:if>
                                    <s:if test="value.nzgr != null && value.nzgr.length() > 0">
                                            <br/><s:property value="value.nzgr" escapeHtml="false"/>
                                    </s:if>
                                    <s:if test="value.kgvn != null && value.kgvn.length() > 0">
                                            <br/>ГНГ-<s:property value="value.kgvn" escapeHtml="false"/><br/>
                                    </s:if>
                    ...
                    <tr>
                        <td width="40"></td>
                        <td width="56"></td>
                        <td width="438"><s:property value="smgs.g11_primDisp()" escapeHtml="false"/></td>
                    </tr>
                </table>
</div>
...
<div class="d238_2">
            ...
            <div class="d24">
                <s:property value="smgs.g14Gu27vDisp()" escapeHtml="false"/>
</div>
<div class="d25">
...
<div class="d251_2">
  ...
  <div class="d252">
            ...
            <div class="d252_1">
                <s:property value="smgs.zpuInfo1" escapeHtml="false"/>
            </div>
<div class="d253">
...
<s:if test="%{#inx.index == 3}">
    ...
    <s:if test="print.page1Back">
        ...
        <div style="position:relative; float:left; clear:left;width:750px;height:1071px;">
            <div class="d28">
